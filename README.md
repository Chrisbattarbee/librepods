This fork of librepods is an extension of the work done in the [rust-linux branch](https://github.com/kavishdevar/librepods/pull/241).
It adds the following features to the linux app that I found useful:

- Support for seamless switching - head to settings tab to enable it. This allows you to switch audio betweeen an apple device like an iPhone and your linux device without disconnecting / reconnecting.
- Pressing the stem of the airpods will pause / resume playback.
